...
__webpack_require__.d(__webpack_exports__, {
  "S5": () => (/* binding */ formatFixed),
  "Ox": () => (/* binding */ parseFixed)
});

// UNUSED EXPORTS: FixedFormat, FixedNumber
...
const _version_version = "bignumber/5.6.0";
//# sourceMappingURL=_version.js.map
// EXTERNAL MODULE: ./node_modules/bn.js/lib/bn.js
var bn = __webpack_require__(550);
...
const bignumber_logger = new lib_esm/* Logger */.Yd(_version_version);
...
class BigNumber {
    constructor(constructorGuard, hex) {
        ...
        if (constructorGuard !== _constructorGuard) {
            bignumber_logger.throwError("cannot call constructor directly; use BigNumber.from", lib_esm/* Logger.errors.UNSUPPORTED_OPERATION */.Yd.errors.UNSUPPORTED_OPERATION, {
    ...
    toBigInt() {
        ...
        return bignumber_logger.throwError("this platform does not support BigInt", lib_esm/* Logger.errors.UNSUPPORTED_OPERATION */.Yd.errors.UNSUPPORTED_OPERATION, {
            value: this.toString()
        });
    }
    toString() {
        ...
        if (arguments.length > 0) {
            if (arguments[0] === 10) {
                ...
                bignumber_logger.throwError("BigNumber.toString does not accept any parameters; use bigNumber.toHexString()", lib_esm/* Logger.errors.UNEXPECTED_ARGUMENT */.Yd.errors.UNEXPECTED_ARGUMENT, {});
            }
            else {
                bignumber_logger.throwError("BigNumber.toString does not accept parameters", lib_esm/* Logger.errors.UNEXPECTED_ARGUMENT */.Yd.errors.UNEXPECTED_ARGUMENT, {});
            }
        }
...
function throwFault(fault, operation, value) {
    ...
    return bignumber_logger.throwError(fault, lib_esm/* Logger.errors.NUMERIC_FAULT */.Yd.errors.NUMERIC_FAULT, params);
}
...
const fixednumber_logger = new lib_esm/* Logger */.Yd(_version_version);
...
function fixednumber_throwFault(message, fault, operation, value) {
    ...
    return fixednumber_logger.throwError(message, lib_esm/* Logger.errors.NUMERIC_FAULT */.Yd.errors.NUMERIC_FAULT, params);
}
...
class FixedFormat {
    constructor(constructorGuard, signed, width, decimals) {
        if (constructorGuard !== fixednumber_constructorGuard) {
            fixednumber_logger.throwError("cannot use FixedFormat constructor; use FixedFormat.from", lib_esm/* Logger.errors.UNSUPPORTED_OPERATION */.Yd.errors.UNSUPPORTED_OPERATION, {
...
class FixedNumber {
    constructor(constructorGuard, hex, value, format) {
        ...
        if (constructorGuard !== fixednumber_constructorGuard) {
            fixednumber_logger.throwError("cannot use FixedNumber constructor; use FixedNumber.from", lib_esm/* Logger.errors.UNSUPPORTED_OPERATION */.Yd.errors.UNSUPPORTED_OPERATION, {
                operation: "new FixedFormat"
            });
        }
        this.format = format;
    ...
    static from(value, format) {
        ...
        try {
            ...
            if (error.code !== lib_esm/* Logger.errors.INVALID_ARGUMENT */.Yd.errors.INVALID_ARGUMENT) {
                throw error;
            }
        }
...
// EXTERNAL MODULE: ./node_modules/@ethersproject/bignumber/lib.esm/fixednumber.js + 4 modules
var fixednumber = __webpack_require__(2);
// EXTERNAL MODULE: ./node_modules/@ethersproject/logger/lib.esm/index.js + 1 modules
var lib_esm = __webpack_require__(711);
...
var units_1 = __webpack_require__(441);
...
(function (module, exports) {
  ...
  try {
    if (typeof window !== 'undefined' && typeof window.Buffer !== 'undefined') {
      ...
      Buffer = (__webpack_require__(300).Buffer);
    }
  } catch (e) {
  }
 ...
 */
var f=__webpack_require__(156),k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m=Object.prototype.hasOwnProperty,n=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p={key:!0,ref:!0,__self:!0,__source:!0};
...
// EXTERNAL MODULE: ./node_modules/@ethersproject/bignumber/lib.esm/fixednumber.js + 4 modules
var fixednumber = __webpack_require__(2);
// EXTERNAL MODULE: ./node_modules/big-number-input/lib/index.js
var lib = __webpack_require__(789);
...
function BigNumberInput(_a) {
  ...
  var _useState = (0,external_react_.useState)(value.toString()),
  ...
  var handleInputChange = function handleInputChange(targetValue) {
    ...
    onChange && onChange((0,fixednumber/* parseFixed */.Ox)(newValue));
  };
  ...
  return (0,jsx_runtime.jsx)(lib.BigNumberInput, Object.assign({}, props, {
    value: displayValue,
